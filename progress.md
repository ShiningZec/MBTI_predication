...
| 优先级 | 事项 | 说明 |
|:------:|------|------|
| 🔴 | **超参数调优** | max_length、batch_size、dropout、lr、head_hidden、pooling 策略的系统搜索（网格/Optuna） |
| 🔴 | **max_length=512 重新训练** | 当前模型仅用 256 训练，512 重训预期提 3-5% |
| 🟡 | **增加训练 epoch** | 当前 3 epoch，Test Loss 尚在下降 |
